...
const postAnOrder = asyncHandler(async (req, res) => {
	const { name, details, image, qty, destination, status, currentWarehouse, expectedArrivalTime, currentLocation, otherInformation } = req.body;
...
module.exports = { getAllOrders, getAnOrder, updateAnOrder, deleteAnOrder, getOrderByShareable, deleteAllOrders, postAnOrder };
